...
import { Home, Users, MessageSquare, Settings, LogOut, LockKeyhole } from "lucide-react"
    ...
    <Sidebar className="bg-[#0B1120] text-gray-300 border-none w-64">
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton asChild>
                <a href="/home" className="flex items-center gap-3 px-6 py-2 hover:bg-[#1E293B] rounded-lg transition">
            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild>
                <a href="/apikeys" className="flex items-center gap-3 px-6 py-2 hover:bg-[#1E293B] rounded-lg transition">
            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild>
                <a href="/configuration" className="flex items-center gap-3 px-6 py-2 hover:bg-[#1E293B] rounded-lg transition">
      ...
      <SidebarFooter className="px-6 py-4 border-t border-gray-800">
        <button className="flex items-center gap-3 text-sm text-gray-400 hover:text-white transition">
          <LogOut className="w-4 h-4 bg-blue-500" />
          Cerrar sesión
        </button>
      </SidebarFooter>
    </Sidebar>
