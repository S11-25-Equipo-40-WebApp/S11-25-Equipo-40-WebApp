...
class TestGetUserById:
    ...
    def test_get_user_by_id_not_found(self):
        ...
        with pytest.raises(HTTPException) as exc_info:
            UserService.get_user_by_id(mock_db, user_id)
...
class TestUpdateUser:
    ...
    def test_update_user_success(self):
        ...
        mock_data = Mock()
        mock_data.dict.return_value = {"email": "newemail@example.com"}

        UserService.update_user(mock_db, user_id, mock_data)
...
class TestGetUserByEmail:
    ...
    def test_get_user_by_email_not_found(self):
        ...
        with pytest.raises(HTTPException) as exc_info:
            UserService.get_user_by_email(mock_db, "notfound@example.com")
